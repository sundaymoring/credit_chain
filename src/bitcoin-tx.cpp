...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s coinnet-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  coinnet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coinnet transaction") + "\n" +
              "  coinnet-tx [options] -create [commands]   " + _("Create hex-encoded coinnet transaction") + "\n" +
              "\n";
