 ...
 * */
static const CAmount MAX_MONEY = int64_t(10)  * int64_t(10000 * 10000) * int64_t(COIN * COIN_SCALE);
static const CAmount MAX_TOKEN = int64_t(900) * int64_t(10000 * 10000) * int64_t(COIN * COIN_SCALE);
