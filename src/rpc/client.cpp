...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "tokensendmany", 1, "amounts" },
//    { "tokensendmany", 3, "minconf" },
    ...
    { "getrawtransaction", 1, "verbose" },
    { "createtokenrawtransaction", 0, "inputs" },
    { "createtokenrawtransaction", 1, "outputs" },
    { "createtokenrawtransaction", 2, "locktime" },
    ...
    { "issuenewtoken", 1, "type" },
    { "issuenewtoken", 2, "amount" },
