...
UniValue gettxout(const JSONRPCRequest& request)
{
    ...
    if (coins.vout[n].tokenID != TOKENID_ZERO){
        ret.push_back(Pair("tokenID", coins.vout[n].tokenID.ToBase58IDString()));
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    ...
    for (std::vector<std::pair<CAddressIndexKey, COutValue> >::const_iterator it=addressIndex.begin(); it!=addressIndex.end(); it++) {
        ...
        if (it->second.tokenID != TOKENID_ZERO){
            delta.push_back(Pair("tokenid", it->second.tokenID.ToBase58IDString()));
            CTokenInfo info;
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    ...
    for (std::vector<std::pair<CAddressUnspentKey, CAddressUnspentValue> >::const_iterator it=unspentOutputs.begin(); it!=unspentOutputs.end(); it++) {
        ...
        if (it->second.outValue.tokenID != TOKENID_ZERO){
            output.push_back(Pair("tokenid", it->second.outValue.tokenID.ToBase58IDString()));
            CTokenInfo info;
...
{ //  category              name                      actor (function)         okSafe argNames
  ...
  // for insight explorer
    { "blockchain",         "getblockhashes",         &getblockhashes,         true,  {"newer_timestamp", "older_timestamp", "arg2"} },
    { "blockchain",         "getspentinfo",           &getspentinfo,           false, {"verbose"} },
    { "addressindex",       "getaddresstxids",        &getaddresstxids,        false, {"verbose"} },
    { "addressindex",       "getaddressbalance",      &getaddressbalance,      false, {"verbose"} },
    { "addressindex",       "getaddressdeltas",       &getaddressdeltas,       false, {"verbose"} },
    { "addressindex",       "getaddressutxos",        &getaddressutxos,        false, {"verbose"} },
    { "addressindex",       "getaddressmempool",      &getaddressmempool,      true,  {"verbose"} },
